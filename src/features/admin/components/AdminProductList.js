  ...
  return (
    <div className="bg-white p-2">
      <div>
        ...
        <main className="mx-auto max-w-8xl px-2 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-6">
            ...
            <div className="flex items-center">
              ...
              <button
                ...
                onClick={() => setMobileFiltersOpen(true)}     // error occured
              >
...
function Pagination({page, setPage, handlePage, totalItems}) {
  ...
  return (  <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
        <div className="flex flex-1 justify-between sm:hidden">
              <button onClick={e=>handlePage(page>1 ? page-1 : page)} disabled={page <= 1}
                // className="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
                className={`relative ml-3 inline-flex items-center rounded-md border ${page <= 1 ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'} px-4 py-2 text-sm font-medium`}
              >
                Previous
              </button>
              <button onClick={e=>handlePage(page<totalPages ? page+1 : page)} disabled={page + 1 > Math.ceil((totalItems / ITEMS_PER_PAGE))}
                // className="relative ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
               className={`relative ml-3 inline-flex items-center rounded-md border ${page + 1 > Math.ceil((totalItems / ITEMS_PER_PAGE)) ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'} px-4 py-2 text-sm font-medium`}
              >
                Next
              </button>
            </div>
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
              ...
              >
                {index+1}
                  ...
                  <button
                    onClick={e=>handlePage(page<totalPages ? page+1 : page)} disabled={page + 1 > Math.ceil((totalItems / ITEMS_PER_PAGE))}
