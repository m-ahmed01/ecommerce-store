    ...
    return ( 
      ...
      {!params.id && <Navigate to='/' replace = {true}> </Navigate>}
        ...
        <div className="text-center">
          ...
          <br></br>
          <div className="mt-4 text-2xl font-bold tracking-tight text-gray-00 sm:text-3xl"><b className="text-green-600">Order Number# </b>{params?.id}</div>
          <p className="mt-6 text-base leading-7 text-gray-600">You can check your orders in<b> My Orders</b> </p>
